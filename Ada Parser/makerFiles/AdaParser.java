...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
  ...
  private static final byte[] yypact_init()
  {
    return new byte[]
    {
      18,    18,    18,    -9,    16,   -51,   -51,   -51,    10,   -51,
      32,     9,     9,     9,    42,    49,    18,   -51,   -51,    44,
       1,    53,    51,     4,   -51,    55,     1,   -51,   -51,   -51,
     -51,    41,    43,   -51,    59,    48,    62,    60,     1,    63,
      65,    24,     1,   -51,   -51,    56,   -51,   -51,   -51,     1,
     -51,   -51,   -51,     1,     9,    64,     4,     1,    66,    50,
       4,     4,   -51,   -51,   -51,    68,    71,   -17,   -51,    41,
      43,   -51,    39,   -51,   -51,    70,     4,     1,   -51,   -51,
      73,     4,     1,     1,   -51,   -51,   -51,   -51,    74,   -51,
      54,     4,     4,   -51,    52,    58,     4,   -51,   -51,   -51,
     -51,   -51,     1,   -51,    57,   -51
    };
  }
...
/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
  ...
  private static final byte[] yydefact_init()
  {
    return new byte[]
    {
       ...
       0,     0,     0,    18,     6,    16,     0,    48,    50,    51,
      13,    41,    39,    47,     0,     0,     0,     0,     0,     0,
       0,     0,     0,    11,    17,     0,    45,    46,    37,     0,
      43,    44,    38,     0,     7,    14,    18,     0,     0,     0,
      18,    18,    34,    35,    36,     0,     0,     0,    49,    41,
      39,    10,     0,    12,    19,     0,    18,     0,    25,    24,
      26,    18,     0,     0,    31,    42,    40,    15,     0,    23,
      29,    18,    18,    21,     0,     0,    18,    30,    28,    27,
      22,    32,     0,    20,     0,    33
    };
  }
...
/* YYPGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yypgoto_init()
  {
    return new byte[]
    {
     -51,   -51,    22,   -11,   -51,   -51,    67,   -50,   -51,   -51,
     -51,   -51,   -51,   -51,   -23,    31,    12,    14,   -51,   -51,
     -38,    13
    };
  }
...
/* YYDEFGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yydefgoto_init()
  {
    return new byte[]
    {
      -1,     4,     5,    16,    21,    73,    22,    43,    92,    58,
      98,    66,    84,    65,    30,    31,    52,    48,    53,    49,
      32,    33
    };
  }
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  private static final byte[] yytable_init()
  {
    return new byte[]
    {
      59,    17,    18,    45,    67,    82,    74,     8,    36,    83,
      78,    79,    12,    13,    26,    70,     9,    27,    28,    29,
      37,     1,     2,     6,     7,    14,    89,    38,    39,    40,
      10,    93,    41,    42,    75,    11,    15,     3,    24,    90,
      62,    99,   100,    71,    94,    95,   103,    63,    19,    20,
      46,    47,    23,    64,    50,    51,    28,    29,    34,    35,
      25,    19,    54,    55,   104,    56,    60,    57,    61,    76,
      68,    72,    77,    80,    81,    88,    91,    96,    97,   102,
      69,   101,    86,    85,     0,    87,   105,     0,     0,     0,
       0,     0,    44
    };
  }
...
private static final byte[] yycheck_ = yycheck_init();
  private static final byte[] yycheck_init()
  {
    return new byte[]
    {
      38,    12,    13,    26,    42,    22,    56,    16,     4,    26,
      60,    61,     3,     4,    13,    53,     0,    16,    17,    18,
      16,     3,     4,     1,     2,    16,    76,    23,    24,    25,
      20,    81,    28,    29,    57,     3,    27,    19,    16,    77,
      16,    91,    92,    54,    82,    83,    96,    23,     6,     7,
       9,    10,     3,    29,    11,    12,    17,    18,     5,     8,
      16,     6,     3,    15,   102,     3,     3,     7,     3,     3,
      14,     7,    22,     5,     3,     5,     3,     3,    24,    21,
      49,    29,    70,    69,    -1,    72,    29,    -1,    -1,    -1,
      -1,    -1,    25
    };
  }
...
/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
  ...
  private static final byte[] yystos_init()
  {
    return new byte[]
    {
      ...
      45,    46,    51,    52,     5,     8,     4,    16,    23,    24,
      25,    28,    29,    38,    37,    45,     9,    10,    48,    50,
      11,    12,    47,    49,     3,    15,     3,     7,    40,    51,
       3,     3,    16,    23,    29,    44,    42,    51,    14,    46,
      51,    34,     7,    36,    38,    45,     3,    22,    38,    38,
       5,     3,    22,    26,    43,    48,    47,    52,     5,    38,
      51,     3,    39,    38,    51,    51,     3,    24,    41,    38,
      38,    29,    21,    38,    51,    29
    };
  }
...
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
  ...
  private static final int YYLAST_ = 92;
